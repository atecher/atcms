...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>${web_manager_title} - 登录</title>
...
<body class="gray-bg" >
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            <div>
                <h1 class="logo-name"><img src="${pageContext.request.contextPath}/asset/favicon/favicon.png"/></h1>
            </div>
            <h3>欢迎使用 ATecher</h3>
            <form class="m-t" role="form" action="${pageContext.request.contextPath}/account/login" method="post">
