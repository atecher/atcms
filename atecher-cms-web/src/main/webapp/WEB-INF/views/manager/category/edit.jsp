            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="tabs-container">
                        <form class="form-horizontal" action="${pageContext.request.contextPath}/manage/category/save" method="post" enctype="multipart/form-data" id="categoryForm">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="keywords" placeholder="可以填写关键信息，有助于优化互联网搜索" class="form-control" value="${article.cover_path}">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="file-manager">
                        <div class="form-group">
                            <label>选择分类：</label>
                            <div id="category_treeview" class="test" data-category-name="${category.parent.category_name}" data-category-id="${category.parent_id}"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="clearfix"></div>
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#returnList").on("click", function () {
            window.location.href = "${pageContext.request.contextPath}/manage/category";
        });
    });
</script>
</body>
