                    ...
                    <div class="example-wrap">
                        <div class="example">
                            ...
                            <table id="dataTableEvents"
                                   ...
                                   data-url="${pageContext.request.contextPath}/manage/article/data" data-cache="false" data-striped="true" data-method="post" data-data-type="json" data-content-type="application/x-www-form-urlencoded"
...
<script type="text/javascript">
    $(function () {
        ...
        $("#addArticle").on("click", function () {
            window.location.href = "${pageContext.request.contextPath}/manage/article/add";
        });
    ...
    function operateFormatter(value, row, index) {
        return [
            '<button class="module btn btn-warning btn-circle btn-tb" title="加入模块">',
    ...
    window.operateEvents = {
        'click .module': function (e, value, row, index) {
            parent.layer.open({
                type: 2,
                title: '加入模块',
                shadeClose: true,
                ...
                area: ['1150px', '650px'],
                content: ['${pageContext.request.contextPath}/manage/article/module/' + row.article_id], //iframe的url，no代表不显示滚动条
                end: function () { //此处用于演示
        ...
        'click .edit': function (e, value, row, index) {
            window.location.href = '${pageContext.request.contextPath}/manage/article/edit/' + row.article_id;
        },
        'click .remove': function (e, value, row, index) {
            parent.layer.confirm('您确认要删除这条数据吗？', {
                ...
                $.getJSON("${pageContext.request.contextPath}/manage/article/remove/" + row.article_id, function (data) {
