                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="hidden-xs" id="dataTableEventsToolbar" role="group">
                                <button type="button" class="btn btn-info btn-circle" id="newUrlRewrite">
                                    <i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-circle" id="deleteBatch">
                                    <i class="glyphicon glyphicon-trash" aria-hidden="true"></i>
                                </button>
                            </div>
                            <table id="dataTableEvents"
                                   data-height="600" data-mobile-responsive="true"
                                   data-url="${pageContext.request.contextPath}/admin/urlrewrite/data" data-cache="false" data-striped="true" data-method="post" data-data-type="json" data-content-type="application/x-www-form-urlencoded"
                                ...
                                <tr>
                                    ...
                                    <th data-field="urlFrom" data-align="center" data-valign="middle" data-sortable="true">URL_FROM</th>
                                    <th data-field="urlTo" data-align="center" data-valign="middle">URL_TO</th>
                                    <th data-field="urlToType" data-align="center" data-valign="middle">重写类型</th>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#newUrlRewrite").on("click", function () {
            window.location.href = '${pageContext.request.contextPath}/admin/urlrewrite/add';
        });
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row, index) {
            window.location.href = '${pageContext.request.contextPath}/admin/urlrewrite/edit/' + row.id;
        },
        'click .remove': function (e, value, row, index) {
            parent.layer.confirm('您确认要删除这条数据吗？', {
                ...
                $.getJSON("${pageContext.request.contextPath}/admin/urlrewrite/remove/" + row.id, function (data) {
