                    ...
                    <div class="example-wrap">
                        <div class="example">
                            ...
                            <table id="dataTableEvents"
                                   ...
                                   data-url="${pageContext.request.contextPath}/manage/category/data" data-cache="false" data-striped="true" data-method="post" data-data-type="json" data-content-type="application/x-www-form-urlencoded"
...
<script type="text/javascript">
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row) {
            window.location.href = '${pageContext.request.contextPath}/manage/category/edit/' + row.category_id;
        },
        'click .remove': function (e, value, row) {
            parent.layer.confirm('您确认要删除这条数据吗？', {
                ...
                $.getJSON("${pageContext.request.contextPath}/manage/category/disable/" + row.category_id, function (data) {
