...
<head>
   ...
   <link href="http://cdn.bootcss.com/bootstrap/3.3.6/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="${pageContext.request.contextPath}/asset/console/css/plugins/iCheck/custom.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/asset/console/css/style.min.css" rel="stylesheet"/>
    <link href="${pageContext.request.contextPath}/asset/console/css/plugins/treeview/bootstrap-treeview.css" rel="stylesheet">
...
<body class="gray-bg" >
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
              <div class="tabs-container">
                     <form class="form-horizontal" action="${pageContext.request.contextPath}/manage/article/save" method="post"  id="articleForm">
                           ...
                           <input type="hidden" name="status"  id="status" value="${article.status}"/>
                            <div class="panel-body">
                            	...
                            	<div class="form-group">
                                	...
                                	<div class="col-sm-4">
                                    <c:choose>
										<c:when test="${not empty article.author}"><input name="author" type="text" value="${article.author}"  class="form-control" placeholder="请输入作者..."/></c:when>
										<c:otherwise><input name="author" type="text" value="${website_current_user.name}"  class="form-control" placeholder="请输入作者..."/></c:otherwise>
									</c:choose>
                                	</div>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
	                            <label>文章属性：</label>
	                         	...
	                         	<c:choose>
	                         	<c:when test="${article.status==0}">已删除</c:when>
	                         	<c:when test="${article.status==1}">草稿</c:when>
	                         	<c:when test="${article.status==2}">发布</c:when>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/asset/console/js/plugins/iCheck/icheck.min.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/asset/console/js/plugins/ueditor/ueditor.config.js?v=1.2" charset="utf-8"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/asset/console/js/plugins/ueditor/ueditor.all.min.js?v=1.2" charset="utf-8"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/asset/console/js/plugins/treeview/bootstrap-treeview.js"></script>
    ...
    <script>
        $(document).ready(function(){
        	...
        	$.ajax({
				 url: "${pageContext.request.contextPath}/manage/article/categoryTree",
				 method:"post",
               dataType: "json",
               traditional:true,
       	...
       	$("#savePublish").click(function(){
        	...
        	$("#returnList").on("click",function(){
        		window.location.href="${pageContext.request.contextPath}/manage/article";
        	});
        	});
    </script>
</body></html>