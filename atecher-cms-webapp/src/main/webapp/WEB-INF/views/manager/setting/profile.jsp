            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="tabs-container">
                        <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/profile" method="post" id="profileForm">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="profile_is_enabled_reg" type="radio" value="1"
                                               <c:if test="${profile.is_enabled_reg=='1' }">checked</c:if> />
                                        <span class="lbl">是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                        <input name="profile_is_enabled_reg" type="radio" value="0" <c:if test="${profile.is_enabled_reg=='0' }">checked</c:if>/>
...
<script type="text/javascript">
    $("#returnSetting").click(function () {
        window.location.href = "${pageContext.request.contextPath}/admin/setting";
    })
